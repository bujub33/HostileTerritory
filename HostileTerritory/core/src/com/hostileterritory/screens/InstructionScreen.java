...
public class InstructionScreen implements Screen{
    ...
    public InstructionScreen(HostileTerritory game2) {
        ...
        instructionDoubleJump = new Label("\"Arrow Key UPx2\" to double Jump!", new Label.LabelStyle(font, Color.BLACK));
        instructionDoubleJump.setPosition(390,350);
        instructionSlide = new Label("\"Arrow Key DOWN\" to Slide!", new Label.LabelStyle(font, Color.BLACK));
        ...
        stage.addActor(instructionDoubleJump);
